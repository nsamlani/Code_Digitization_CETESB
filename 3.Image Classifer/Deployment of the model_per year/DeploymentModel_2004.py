...
Model Deployment code for the year 2004
...
#         gray = cv2.cvtColor(imgCrop,cv2.COLOR_BGR2GRAY)
        ...
        #### Change the size to the target size of the model
...
# pixel_boxes.to_excel(f'../Final_Boxes/{year}.xlsx.xlsx')
