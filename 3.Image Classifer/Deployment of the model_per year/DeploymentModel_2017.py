...
Model Deployment code for the year 2017
...
#     cv2.putText(img=img, text=r[3],org =(x-3,y-3), fontFace=cv2.FONT_HERSHEY_TRIPLEX, fontScale=0.35, color=(0, 0, 0),
#                 thickness=0)
...
# pixel_boxes.to_excel(f'../../3.Output/dec2017/Pixel_box_trial_{year}_updated.xlsx')
