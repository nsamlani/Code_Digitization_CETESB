...
Files: Folder of images of teh year 2013
"""
...
folder = r"Registry2013_300dpi"
year = "2013"

forms_list = os.listdir(folder)
print(forms_list)

roi = [[(118, 251), (2311, 308), 'text', 'Company Name'], 
       [(119, 316), (2311, 363), 'text', 'Address'], 
       [(405, 422), (583, 467), 'text', 'fuse'], 
       [(705, 423), (958, 469), 'text', 'Datum'], 
       [(1083, 422), (1290, 469), 'text', 'UTM_E'], 
       [(1406, 422), (1666, 472), 'text', 'UTM_N'], 
       [(342, 477), (1848, 522), 'text', 'Classification']]
